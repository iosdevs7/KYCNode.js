...
var getTraits = require('./textsummary');
var personality = require('./personality');
require('./d3.js');
require('./d3.min.js');
// $(document).ready(function() {

$("head").append('<script type="text/javascript" src = "http://d3js.org/d3.v3.min.js" charset="utf-8"></script>');
...
//    * values.
//    */
  module.exports.showTextSummary = function showTextSummary(data) {
   // var paragraphs = getTraits.assembleTraits(data.tree.children[0]);
   // var paragraphs = data.tree.children[0];
    // console.log('showTextSummary()');
   // console.log('data');
   // console.log('data.tree.children[0]');
    var paragraphs = [
      getTraits.assembleTraits(data.tree.children[0]),
      getTraits.assembleFacets(data.tree.children[0]),
      getTraits.assembleValues(data.tree.children[2])
    ];
    // var div = $('.summary-div');
    // div.empty();
...
//  */
module.exports.showVizualization = function showVizualization(theProfile) {
  ...
  personality.renderChart.call(widget);
